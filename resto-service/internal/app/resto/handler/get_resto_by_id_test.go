...
// Test for the endpoint GET /restos/{id}
func TestGetRestoById(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/restos/1", nil)
	...
	// TODO: Additional checks for the returned resto
